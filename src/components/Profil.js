...
const Profil = () => {
  ...
  async function desactiver(id) {
    ...
    //getAllProfil();
    alert('sous menu supprimé avec succès')
    window.location.reload();
  }
 ...
 */}
        ...
        <button style={{ marginTop: '80px', borderRadius: '100px', marginRight: '30px', border: '1px solid white', width: '100px', backgroundColor: 'white' }} > </button>
        {
          disabled == 'true' ?
            ...
            <button disabled onClick={addprofil} style={{ marginLeft: '45px', marginTop: '0px', borderRadius: '100px', marginRight: '30px', border: '1px solid #ACD3F2', width: '100px', backgroundColor: '#E9F2FF' }} >Enrégistré </button>
            :
            <button onClick={addprofil} style={{ marginLeft: '45px', marginTop: '0px', borderRadius: '100px', marginRight: '30px', border: '1px solid #ACD3F2', width: '100px', backgroundColor: '#E9F2FF' }} >Enrégistré </button>
